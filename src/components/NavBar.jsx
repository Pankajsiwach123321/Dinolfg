    ...
    <div>
      <nav className=" py-[28px]">
        <div className=" max-w-[1164px] px-3 mx-auto">
          <div className=" lg:py-[15.8px] py-3 lg:ps-6 lg:pe-2 px-4 bg-white rounded-[61.102px] border-b-4 border-b-[black] flex items-center justify-between sm:mb-20 mb-10 h-[67px]">
            <ul>
              <li>
                <a href="#">
