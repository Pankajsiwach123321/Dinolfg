    ...
    <div>
      <nav className=" py-[28px]">
        <div className=" max-w-[1164px] px-3 mx-auto">
          <div className=" lg:py-[15.8px] py-3 lg:ps-6 lg:pe-2 px-4 bg-white rounded-[61.102px] border-b-4 border-b-[black] flex items-center justify-between sm:mb-[55px] mb-[35px] h-[67px]">
            <ul>
              <li>
                <a href="#home">
                  <h2 className=" font-lucky font-normal  leading-[37px] drop-shadow-[0px_1.337px_0px_#000]   text-[#FBA11D] sm:text-[40px] text-[28px]">
            ...
            >
              ...
              <li className="gap-2 items-center sm:hidden flex">
                ...
                >
                  ...
                  >
                    <circle
                      className="group-hover:stroke-[#8F78D2] transition-all duration-300 ease-linear"
                      cx="18.5"
                      cy="18.5"
                      r="18"
                      stroke="black"
                ...
                >
                  ...
                  >
                    <circle
                      className="group-hover:stroke-[#D45B07] transition-all duration-300 ease-linear"
                      cx="18.5"
                      cy="18.5"
                      r="18"
                      stroke="black"
              ...
              <ul className="gap-2 items-center sm:flex hidden">
                <li>
                  <a href="https://www.twitter.com" target="_blank">
                    ...
                    >
                      <circle
                        className="group-hover:stroke-[#23AAAC] transition-all duration-300 ease-linear"
                        cx="18.5"
                        cy="18.5"
                        r="18"
                        stroke="black"
                ...
                <li>
                  <a href="https://www.discord.com" target="_blank">
                    <svg
                      className="group hover:fill-[#8F78D2] transition-all duration-300 ease-linear"
                      width="37"
                      height="37"
                      viewBox="0 0 37 37"
                      fill="none"
                ...
                <li>
                  <a
                    href=""
                    className="bg-[url(./assets/images/joinbtnbg.webp)] bg-fullsize bg-no-repeat text-black font-chewy text-[18px] font-normal leading-normal px-9 pt-[10px] pb-[17px] lg:block hidden hover:text-white transition-all duration-300 ease-in-out"
                  >
                    Join Now
                  </a>
                </li>
