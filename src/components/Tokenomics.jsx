  ...
  return (
    <div className="bg-[#0A4740] -mt-[2px] relative z-[1]" id="Tokenomic">
      ...
      <img
        src={layergray}
        alt="loyelggrey"
        className=" absolute right-[0%] z-[-1] top-[18%] max-w-[709px] max-h-[267px]"
      />
      <div className=" max-w-[1164px] mx-auto px-3 sm:pt-[100px] pt-[70px] lg:pt-[246px] pb-[35px] sm:pb-[100px] lg:pb-[428px]">
        ...
        <div className="  relative z-[2]">
          ...
          <div
            data-aos="fade-right"
            className=" flex justify-center max-lg:mt-[20px] max-lg:border-4 max-sm:backdrop-blur-sm border-[#FBA11D]  border-dotted max-lg:p-5 mx-auto rounded-full max-lg:max-w-[500px] items-center gap-[26px] lg:absolute top-[35px] left-[1%]"
          >
            <div className=" max-w-[189px] text-center lg:text-end">
              ...
              <p className=" text-white font-normal text-2xl font-BalsamiqSans pt-[5px] leading-[33px]">
                Supply
              </p>
            </div>
          ...
          <div
            data-aos="fade-up"
            className=" flex justify-center max-lg:mt-[20px] max-lg:border-4 max-sm:backdrop-blur-sm border-[#23AAAC] border-dotted max-lg:p-5 mx-auto rounded-full max-lg:max-w-[500px] items-center gap-[26px] lg:absolute top-[76%] left-[11%]"
          >
          ...
          <div
            data-aos="zoom-in"
            className=" flex flex-col max-lg:mt-[20px] max-lg:border-4 max-sm:backdrop-blur-sm border-[#D45B07] border-dotted max-lg:p-5 mx-auto rounded-full max-lg:max-w-[500px] justify-center items-center gap-[17px] lg:absolute bottom-[-41%] left-[45%]"
          >
            <div className=" lg:block hidden border-r-[1.48px] border-white  w-[15px] h-[43px]  border-b-0"></div>
            <div className=" max-w-[203px] text-center lg:text-end">
              <p className=" text-[#D45B07] text-[32px] font-normal leading-[38px] font-BalsamiqSans">
                No Tax
              </p>
            </div>
          </div>
          <div
            data-aos="fade-up"
            className=" flex flex-row-reverse max-lg:mt-[20px] max-lg:border-4 max-sm:backdrop-blur-sm border-[#FB5352] border-dotted max-lg:p-5 mx-auto rounded-full max-lg:max-w-[500px] justify-center items-center gap-[26px] lg:absolute top-[83%] right-[7%]"
          >
          ...
          <div
            data-aos="fade-left"
            className=" flex flex-row-reverse max-lg:mt-[20px] max-lg:border-4 max-sm:backdrop-blur-sm border-[#5D9630] border-dotted max-lg:p-5 mx-auto rounded-full max-lg:max-w-[500px] justify-center items-center gap-[26px] lg:absolute top-[35px] right-[1%]"
          >
